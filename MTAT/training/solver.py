...
class Solver(object):
    ...
    def get_model(self):
        if self.model_type == 'fcn':
            ...
            return Model.ShortChunkCNN(method=self.method)
    ...
    def get_validation_score(self, epoch):
        ...
        with open("../models/best_model_scores.txt", 'a') as output_file:
            output_file.write(f"Epoch {epoch}, loss {loss:.4f}, AUC/ROC {roc_auc:.4f}, AUC/PR {pr_auc:.4f}\n")
